...
class RepositoryControllerSpec extends spock.lang.Specification{
    ...
    void "Test maven redirect URL is correct"() {
        ...
        then:"The produced URL is correct"    
            response.redirectUrl == 'https://repo.grails.org/grails/plugins/org/grails/plugins/cloud-foundry/1.0/cloud-foundry-1.0.zip'
    }
    ...
    void "Test that maven direct URL is correct for LATEST_RELEASE"() {
        ...
        then:"The produced URL is correct"    
            response.redirectUrl == 'https://repo.grails.org/grails/plugins/org/grails/plugins/tomcat/2.0.3/tomcat-2.0.3.zip'
