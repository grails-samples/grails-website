...
class DownloadTagLibTests extends GroovyPagesTestCase {
    ...
    void testLinkTag() {
        ...
        file.addToMirrors(name:"Codehaus", urlString:"http://codehaus.org/grails-1.0.3-bin.zip")
        file.addToMirrors(name:"Grails.org", urlString:"http://grails.org/grails-1.0.3-bin.zip")
        download.addToFiles(file)

        file = new DownloadFile(title:"Source Zip")
        file.addToMirrors(name:"Codehaus", urlString:"http://codehaus.org/grails-1.0.3-src.zip")
        file.addToMirrors(name:"Grails.org", urlString:"http://grails.org/grails-1.0.3-src.zip")
        download.addToFiles(file)
        ...
        assertEquals "http://codehaus.org/grails-1.0.3-bin.zip", mirror.urlString
