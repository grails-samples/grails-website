...
<div id="contentArea">
    ...
    <div id="pluginMenu">
        ...
        <div class="createPlugin">
            ...
            <div class="detail">
                If you are interested in creating and distributing a plugin in the Grails central repository, take a look at this <a href="/doc/latest/guide/12. Plug-ins.html">user guide section</a>.
            </div>
        </div>
