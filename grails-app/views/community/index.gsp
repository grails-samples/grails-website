<head>
    ...
    <title>The Grails Community</title>
...
<div id="content" class="content-aside" role="main">
    ...
    <section id="main">
        <article>
            <h2>Grails Community <small>Get Involved!</small></h2>
            <p>Grails has a growing following and if you want to get involved the developers are all nice people (promise!) who are keen to have ideas, code and just about anything contributed. There are a number of ways to get involved with the Grails community.</p>

            <h3>Keep up to date</h3>

            <ul>
                <li>Follow Jacob Aae Mikkelsen's weekly <a href="http://grydeske.net/news/" class="pageLink">"Grails Diary" blog</a>
            ...
            <p>You can also contribute back to the project, for example by raising issues, improving the user guide or providing code patches. Any contributions are very welcome!</p>
            ...
            <ul class="star">
                ...
                <li>Follow what is happening with Grails now and in the future with the Grails <a href="http://jira.codehaus.org/browse/GRAILS" class="pageLink">Issue Tracker</a> and on the <a href="/Roadmap" class="pageLink">Roadmap</a>. Or even better check out the <a href="http://github.com/grails/grails-core" class="pageLink">latest commits</a>!</li>
