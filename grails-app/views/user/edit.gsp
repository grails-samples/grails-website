                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'login', 'errors')}">
                                    <g:textField name="login" maxlength="15" value="${userInstance?.login}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'roles', 'errors')}">
                                    <g:select name="roles" from="${org.grails.auth.Role.list()}" multiple="yes" optionKey="id" size="5" value="${userInstance?.roles*.id}" />
                                </td>
                            </tr>
