<div class="aside">
    ...
    <aside class="filters">
        ...
        <ul>
            ...
            <li class="last<g:if test="${activeFilter == 'supported'}"> active</g:if>"><a href="/plugins?filter=supported"><g:img dir="img/plugin" file="supported.png" /> Supported by SpringSource</a></li>
            <li>
