    ...
    <ul class="wikiActionMenu">
        ...
        <li>
            <a href="${href}" class="actionIcon"
               onclick="YAHOO.util.Connect.setForm('${editFormName}');YAHOO.util.Connect.asyncRequest('POST', '/preview/${content?.title}', {success: function(o){YAHOO.util.Dom.get('previewPane').innerHTML = o.responseText;showPreview();}, failure: function(o){}}, 'update=${updateElement}');return false;" class="actionIcon">
